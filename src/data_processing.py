...
class WikiDataset:
    ...
    def download_and_prepare(self):
        ...
        raw_dataset = load_dataset(self.dataset_name, self.dataset_config, cache_dir=str(self.data_dir))
            ...
            for idx, line in enumerate(raw_dataset[split]["text"]):
                if line and line.strip():
                    token_ids = self.tokenizer.encode(
                        line, add_special_tokens=False, truncation=True, max_length=max_length
                    )
